export default function updateFavicon(): void {
  ...
  const faviconColor = getComputedStyle(document.documentElement).getPropertyValue("--primary-color-hex").trim();

  // Create an SVG string and replace `currentColor` with the CSS variable color
  const svg = `
    ...
    <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
            <g id="D">
                <rect fill='${faviconColor}' height="512" rx="150" width="512" />
                <path
