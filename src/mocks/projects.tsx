...
const projects: TProject[] = [
  {
    ...
    image: fptID,
    description:
      "An SSO (Single Sign-On) system that allows users to log in once and access all FPT services, such as LongChau and FShare, without needing to authenticate repeatedly",
